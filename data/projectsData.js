export const projectsData = [
    ...
    },
    {
        ...
        description:
            "Современный лендинг для магазина растений, созданный с нуля на Vite. Реализован каталог с комплексной фильтрацией, а также полнофункциональная корзина с сохранением в localStorage. Особое внимание уделено детальной стилизации всех интерактивных элементов, включая кастомные селекторы, чекбоксы и toast-уведомления. Для секции контактов настроена отправка данных из формы на локальный бэкенд (json-server), демонстрируя работу с асинхронными запросами без перезагрузки страницы.",
        imageUrl: "/images/projects/green-space.jpg",
        fullImageUrl: "/images/projects/full/green-space-full.jpg",
        tech: ["HTML", "CSS", "JavaScript", "Vite", "JSON Server"],
